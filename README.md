...
데이터 출처 : https://www.kaggle.com/datasets/atulanandjha/lfwpeople
 ...
 원본 데이터 수는 총 ### 개이며, 옆을 바라보는 사진들은 얼굴 형태와 눈의 각도를 계산하는데 있어서 오른쪽 얼굴과 왼쪽 얼굴의 차이가 크기 때문에 정면을 보는 사진들만을 사용하였습니다. 1차로 얼굴 특징점을 사용하여 코왼편얼굴너비 대 코 오른편 얼굴 너비의 비율을 측정하여 정면 사진들을 걸러냈습니다. 2차로는 얼굴 특징점을 사용하여 턱의 각도 측정하여 정면사진을 걸러냈습니다. 추가로 눈, 코, 입, 턱이 가려있는 이미지들도 걸러냈습니다.
